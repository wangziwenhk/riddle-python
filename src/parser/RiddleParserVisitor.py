...
class RiddleParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by RiddleParser#loadExpr.
    def visitLoadExpr(self, ctx:RiddleParser.LoadExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by RiddleParser#charExpr.
    def visitCharExpr(self, ctx:RiddleParser.CharExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by RiddleParser#exprBlend.
    def visitExprBlend(self, ctx:RiddleParser.ExprBlendContext):
        return self.visitChildren(ctx)
    ...
    def visitModifier(self, ctx:RiddleParser.ModifierContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#modifierList.
    def visitModifierList(self, ctx:RiddleParser.ModifierListContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by RiddleParser#tmpleDefine.
    def visitTmpleDefine(self, ctx:RiddleParser.TmpleDefineContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#tmplDefineArg.
    def visitTmplDefineArg(self, ctx:RiddleParser.TmplDefineArgContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#tmplUsed.
    def visitTmplUsed(self, ctx:RiddleParser.TmplUsedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#tmplArg.
    def visitTmplArg(self, ctx:RiddleParser.TmplArgContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#tmplArgList.
    def visitTmplArgList(self, ctx:RiddleParser.TmplArgListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#arrayType.
    def visitArrayType(self, ctx:RiddleParser.ArrayTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#tmplType.
    def visitTmplType(self, ctx:RiddleParser.TmplTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#baseType.
    def visitBaseType(self, ctx:RiddleParser.BaseTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#property.
    def visitProperty(self, ctx:RiddleParser.PropertyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RiddleParser#propertyItem.
    def visitPropertyItem(self, ctx:RiddleParser.PropertyItemContext):
        return self.visitChildren(ctx)
