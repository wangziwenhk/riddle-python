# Generated from D:/Code/riddle-python/RiddleParser.g4 by ANTLR 4.13.2
from antlr4 import *
if "." in __name__:
...
class RiddleParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by RiddleParser#loadExpr.
    def enterLoadExpr(self, ctx:RiddleParser.LoadExprContext):
        pass

    # Exit a parse tree produced by RiddleParser#loadExpr.
    def exitLoadExpr(self, ctx:RiddleParser.LoadExprContext):
        pass
    ...
    # Enter a parse tree produced by RiddleParser#charExpr.
    def enterCharExpr(self, ctx:RiddleParser.CharExprContext):
        pass

    # Exit a parse tree produced by RiddleParser#charExpr.
    def exitCharExpr(self, ctx:RiddleParser.CharExprContext):
        pass
    ...
    # Enter a parse tree produced by RiddleParser#exprBlend.
    def enterExprBlend(self, ctx:RiddleParser.ExprBlendContext):
        pass

    # Exit a parse tree produced by RiddleParser#exprBlend.
    def exitExprBlend(self, ctx:RiddleParser.ExprBlendContext):
        pass
    ...
    def enterModifier(self, ctx:RiddleParser.ModifierContext):
        pass

    # Exit a parse tree produced by RiddleParser#modifier.
    def exitModifier(self, ctx:RiddleParser.ModifierContext):
        pass


    # Enter a parse tree produced by RiddleParser#modifierList.
    def enterModifierList(self, ctx:RiddleParser.ModifierListContext):
        pass

    # Exit a parse tree produced by RiddleParser#modifierList.
    def exitModifierList(self, ctx:RiddleParser.ModifierListContext):
        pass
    ...
    # Enter a parse tree produced by RiddleParser#tmpleDefine.
    def enterTmpleDefine(self, ctx:RiddleParser.TmpleDefineContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmpleDefine.
    def exitTmpleDefine(self, ctx:RiddleParser.TmpleDefineContext):
        pass


    # Enter a parse tree produced by RiddleParser#tmplDefineArg.
    def enterTmplDefineArg(self, ctx:RiddleParser.TmplDefineArgContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmplDefineArg.
    def exitTmplDefineArg(self, ctx:RiddleParser.TmplDefineArgContext):
        pass


    # Enter a parse tree produced by RiddleParser#tmplUsed.
    def enterTmplUsed(self, ctx:RiddleParser.TmplUsedContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmplUsed.
    def exitTmplUsed(self, ctx:RiddleParser.TmplUsedContext):
        pass


    # Enter a parse tree produced by RiddleParser#tmplArg.
    def enterTmplArg(self, ctx:RiddleParser.TmplArgContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmplArg.
    def exitTmplArg(self, ctx:RiddleParser.TmplArgContext):
        pass


    # Enter a parse tree produced by RiddleParser#tmplArgList.
    def enterTmplArgList(self, ctx:RiddleParser.TmplArgListContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmplArgList.
    def exitTmplArgList(self, ctx:RiddleParser.TmplArgListContext):
        pass


    # Enter a parse tree produced by RiddleParser#arrayType.
    def enterArrayType(self, ctx:RiddleParser.ArrayTypeContext):
        pass

    # Exit a parse tree produced by RiddleParser#arrayType.
    def exitArrayType(self, ctx:RiddleParser.ArrayTypeContext):
        pass


    # Enter a parse tree produced by RiddleParser#tmplType.
    def enterTmplType(self, ctx:RiddleParser.TmplTypeContext):
        pass

    # Exit a parse tree produced by RiddleParser#tmplType.
    def exitTmplType(self, ctx:RiddleParser.TmplTypeContext):
        pass


    # Enter a parse tree produced by RiddleParser#baseType.
    def enterBaseType(self, ctx:RiddleParser.BaseTypeContext):
        pass

    # Exit a parse tree produced by RiddleParser#baseType.
    def exitBaseType(self, ctx:RiddleParser.BaseTypeContext):
        pass


    # Enter a parse tree produced by RiddleParser#property.
    def enterProperty(self, ctx:RiddleParser.PropertyContext):
        pass

    # Exit a parse tree produced by RiddleParser#property.
    def exitProperty(self, ctx:RiddleParser.PropertyContext):
        pass


    # Enter a parse tree produced by RiddleParser#propertyItem.
    def enterPropertyItem(self, ctx:RiddleParser.PropertyItemContext):
        pass

    # Exit a parse tree produced by RiddleParser#propertyItem.
    def exitPropertyItem(self, ctx:RiddleParser.PropertyItemContext):
        pass
